      ...
      if(document.getElementById("passcode").value==password)
      {
        ...
        else if(localStorage.getItem("agreedToLegal")=="true")
        {
          if(localStorage.getItem("user")==null)
          {
             ...
             */
            $("#btnEnter").attr("href", "menu/user_info.html").button();
          }
          else
          {
            $("#btnEnter").attr("href", "menu/menu.html").button();
          }
        }
      }
      else
      {
        // Clear the href attribute to prevent accidental navigation on subsequent clicks
        $("#btnEnter").removeAttr("href");
